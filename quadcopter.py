...
class Quadcopter():
    ...
    def compute_speed(self):
        self.lateral_speed = (self.last_position - self.position)*self.cfg['step_freq']
    ...
    def step(self):
        ...
        ctrl_pitch = self.pitch_pid.step(self.setpoint_pitch, self.orientation_euler[1], dt)
        ctrl_roll = self.roll_pid.step(self.setpoint_roll, self.orientation_euler[0], dt)
        ctrl_yaw = self.yaw_pid.step(self.setpoint_yaw, self.ang_speed[2], dt)
